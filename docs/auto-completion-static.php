...
class WechatOaAccountModel
{
     ...
     * @param mixed $value
     * @return $this
     * @see WechatOaAccountModel::whereNot
     */
     ...
     * @param string $expression
     * @return $this
     * @see WechatOaAccountModel::orderByRaw
     */
...
class WechatOaUserModel
{
     ...
     * @param mixed $value
     * @return $this
     * @see WechatOaUserModel::whereNot
     */
    public static function whereNot($column, $value): self
    {
    }
     ...
     * @param string $expression
     * @return $this
     * @see WechatOaUserModel::orderByRaw
     */
    public static function orderByRaw($expression): self
    {
    }
